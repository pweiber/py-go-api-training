...
"""
import pytest
from tests.conftest import get_auth_headers, create_test_book, STRONG_PASSWORD
...
def test_create_review(client):
    ...
    # Create a book
    book = create_test_book(client, title="Reviewable Book", isbn="9787777777771",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_review_rating_validation(client):
    ...
    # Create a book
    book = create_test_book(client, title="Rating Test Book", isbn="9787777777772",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_one_review_per_user_per_book(client):
    ...
    # Create a book
    book = create_test_book(client, title="One Review Book", isbn="9787777777773",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_cannot_review_own_book(client):
    ...
    # Create a book
    book = create_test_book(client, title="My Own Book", isbn="9787777777774",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_delete_own_review(client):
    ...
    # Create a book
    book = create_test_book(client, title="Deletable Review Book", isbn="9787777777775",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_cannot_delete_others_review(client):
    ...
    # Create a book
    book = create_test_book(client, title="Others Review Book", isbn="9787777777776",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_get_book_reviews(client):
    ...
    # Create a book
    book = create_test_book(client, title="Book With Reviews", isbn="9787777777777",
                            published_date="2023-01-15", admin_headers=owner_headers)
    book_id = book["id"]
...
def test_update_review_unauthorized(client):
    ...
    book = create_test_book(client, title="Update Test Book", isbn="9788888888880",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"], f"Book creation failed: {book}"
    book_id = book["id"]
...
def test_delete_review_unauthorized_non_admin(client):
    ...
    book = create_test_book(client, title="Delete Unauth Book", isbn="9788888888881",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
...
def test_get_book_reviews_negative_skip(client):
    ...
    book = create_test_book(client, title="Skip Test Book", isbn="9788888888882",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
...
def test_get_book_reviews_invalid_limit(client):
    ...
    book = create_test_book(client, title="Limit Test Book", isbn="9788888888883",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
...
def test_get_book_reviews_limit_capping(client):
    ...
    book = create_test_book(client, title="Cap Test Book", isbn="9788888888884",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
...
def test_update_review_success(client):
    ...
    book = create_test_book(client, title="Update Success Book", isbn="9788888888890",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
...
def test_admin_can_delete_any_review(client):
    ...
    book = create_test_book(client, title="Admin Delete Test Book", isbn="9788888888891",
                            published_date="2023-01-01", admin_headers=owner_headers)
    assert book["id"]
    book_id = book["id"]
